...
const socialLinks = [
  {
    name: "GitHub",
    url: "https://github.com/rohitbrame",
    icon: (
  ...
  {
    name: "LinkedIn",
    url: "https://linkedin.com/in/rohitbrame",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Twitter",
    url: "https://twitter.com/rohitbrame",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 py-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-gray-300 text-sm">
              © {new Date().getFullYear()} Rohit Bramhe. All rights reserved.
            </p>
          </div>
        </div>
      </div>
